    ...
    <div className="content-page">
      ...
      <div className="content-page-body">
        <div className="content-header">
          ...
          <p className="content-subtitle">Last updated: {new Date().toLocaleDateString()}</p>
        </div>

        <div className="privacy-stub">
          ...
          <ul>
            ...
            <li>
              <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Privacy Policy) refers to AC Software LLC, 7 harness path, plainville, MA.</p>
            </li>
            <li>
              <p><strong>Cookies</strong> are small files that are placed on Your computer, mobile device or any other device by a website, containing the details of Your browsing history on that website, among its many uses.</p>
            </li>
            <li>
              <p><strong>Country/State</strong> refers to: Massachusetts, United States.</p>
            </li>
            <li>
            ...
            <li>
              <p><strong>Website</strong> refers to qubitlab, accessible from <a href="qubitlab.ai" target="_blank">qubitlab.ai</a>.</p>
            </li>
            <li>
          ...
          <ul>
            <li>By email: alex@ac-software.org</li>
          </ul>
        </div>
      </div>
    </div>
