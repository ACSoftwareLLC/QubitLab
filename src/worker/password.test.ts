...
import { hashPassword, verifyPassword, passwordNeedsRehash, PBKDF2_ITERATIONS } from './password.js';
...
async function pbkdf2Sha256(password: string, iterations: number): Promise<string> {
